...
#ifndef RANGES_SX_RANGE_HPP
#define RANGES_SX_RANGE_HPP
...
#include <range/utility/iterator.hpp>
#include <range/utility/compressed_pair.hpp>
#include <range/utility/iterator_concepts.hpp>
...
//          , view_interface<range<I, S>>
        ...
        template<typename T>
        using range_default_sentinel = range<T, T>;
